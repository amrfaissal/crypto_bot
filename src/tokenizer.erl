-file("/Users/faissal/.evm/erlang_versions/otp_src_21.1/lib/erlang/lib/parsetools-2.1.8/include/leexinc.hrl", 0).
...
-file("/Users/faissal/.evm/erlang_versions/otp_src_21.1/lib/erlang/lib/parsetools-2.1.8/include/leexinc.hrl", 14).
...
yystate(18, [69|Ics], Line, Tlen, Action, Alen) ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
...
yystate(15, [106|Ics], Line, Tlen, Action, Alen) ->
...
yystate(13, [73|Ics], Line, Tlen, Action, Alen) ->
    yystate(2, Ics, Line, Tlen+1, Action, Alen);
...
-file("src/tokenizer.xrl", 12).
yyaction_0(TokenChars) ->
     { token, { of_, list_to_binary (TokenChars) } } .

-compile({inline,yyaction_1/1}).
-file("src/tokenizer.xrl", 13).
yyaction_1(TokenChars) ->
     { token, { to_, list_to_binary (TokenChars) } } .

-compile({inline,yyaction_2/1}).
-file("src/tokenizer.xrl", 14).
yyaction_2(TokenChars) ->
     { token, { price, list_to_binary (TokenChars) } } .

-compile({inline,yyaction_3/1}).
-file("src/tokenizer.xrl", 15).
yyaction_3(TokenChars) ->
     { token, { symbol, list_to_binary (TokenChars) } } .

-compile({inline,yyaction_4/0}).
-file("src/tokenizer.xrl", 16).
yyaction_4() ->
     { token, { and_, "," } } .

-compile({inline,yyaction_5/0}).
-file("src/tokenizer.xrl", 17).
yyaction_5() ->
     { token, { and_, "," } } .
...
-file("/Users/faissal/.evm/erlang_versions/otp_src_21.1/lib/erlang/lib/parsetools-2.1.8/include/leexinc.hrl", 313).
